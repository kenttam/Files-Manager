...
class Files extends CI_Controller {
	...
	function download_file($subject, $number, $file)
	{		
		$data = file_get_contents(BASEPATH."files/".$subject."/".$number."/".$file); // Read the file's contents
		$name = $file;
	...
	function display() {
		//echo BASEPATH;
		$data['files'] = directory_map(BASEPATH."/files");
